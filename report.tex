...
\begin{itemize}
\item \textbf{Phase 0 (Baseline Normal Model):} With moderate capacity, the model learns the dataset effectively and generalizes well, showing only minor overfitting. \textbf{Final Test Accuracy: 97.20\%}
